...
import sys
sys.path.insert(0,'/Users/kaizer/Documents/Active Learning/mapal-master')
...
def run(results_path, data_set, query_strategy, budget, test_ratio, seed):
    ...
    print('data_set type : ',type(data_set))
    print('annotators type : ',type(annotators))
    ...
    if query_strategy == 'ceal':
        ...
        print('Reached mapal Query Strategy')
